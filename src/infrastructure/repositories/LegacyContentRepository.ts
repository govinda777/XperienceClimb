...
const mockActiveDestination: DestinationContent = {
  ...
  content: {
    hero: {
      ...
      subtitle: 'Viva a aventura de escalada.',
      description:
    ...
    about: {
      ...
      image: '/images/themes/pedra-bela/pedra-bela-main.jpg',
    },
  },
  beginnerSection: {
    title: 'Nunca Escalou?',
...
const mockPackages: Package[] = [
  {
    ...
    features: [
      '1 via de escalada guiada',
      'Todos os equipamentos incluídos',
      'Seguro aventura',
      'Foto digital do topo',
    ],
  ...
  },
  {
    ...
    features: [
      'Até 4 vias de escalada guiadas',
      'Instrução de técnicas de segurança',
      'Todos os equipamentos incluídos',
      'Seguro aventura',
      'Vídeo do crux gravado por guias',
    ],
  ...
  },
  {
    ...
    description:
      'A experiência vertical definitiva de um dia completo com fotos e almoço inclusos.',
    features: [
      'Vias ilimitadas durante o dia',
      'Almoço rústico no parque incluso',
      'Kit exclusivo Xperience Climb',
      'Todas as fotos e vídeos em alta resolução',
      'Seguro aventura premium',
    ],
  ...
  },
  {
    ...
    description:
      'Assinatura anual premium com acesso garantido a todas as saídas bimestrais do ano.',
    features: [
      '6 saídas bimestrais garantidas',
      'Destinos diferentes ao longo do ano',
      'Brinde exclusivo de boas-vindas',
      'Desconto de 20% para acompanhantes',
    ...
    rules: {
      ...
      maxParticipants: 10,
      requiresExperience: false,
      cancellationPolicy: 'Contrato anual.',
    },
    isActive: true,
  },
];
